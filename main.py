...
window.config(background="#ccffff")
window.resizable(0, 0)
window.overrideredirect(True)

mainframe = Frame(window, bg="#ccffff")
mainframe.grid(row=0, column=0)

titleframe = Frame(mainframe, bd=5, bg="dark blue")
titleframe.grid(row=0, column=0)

titlelabel = Label(titleframe, text="Master Typing", font=(
    'algerian', 25, "bold"), bg="skyblue", fg="white", width=46, bd=10)
...
label_paragraph = Label(
    paragraph_frame, text=paragraph_list[0], wraplength=912, justify=LEFT, font=('arial', 14, 'bold'), bg="white")
...
frame_output = Frame(mainframe, bg="#ccffff")
frame_output.grid(row=3, column=0, pady=5)

elapsed_time_label = Label(
    frame_output, text="Elapsed Time:", font=("Tahona", 12, "bold"), bg="#ccffff", fg="red")
elapsed_time_label.grid(row=0, column=0, padx=5)

elapsed_timer_label = Label(
    frame_output, text="0", font=("Tahona", 12, "bold"), bg="#ccffff")
elapsed_timer_label.grid(row=0, column=1, padx=5)

remaining_time_label = Label(
    frame_output, text="Remaining Time:", font=("Tahona", 12, "bold"), bg="#ccffff", fg="red")
remaining_time_label.grid(row=0, column=2, padx=5)

remaining_timer_label = Label(
    frame_output, text="60", font=("Tahona", 12, "bold"), bg="#ccffff")
remaining_timer_label.grid(row=0, column=3, padx=5)

wpm_label = Label(
    frame_output, text="WPM:", font=("Tahona", 12, "bold"), bg="#ccffff", fg="red")
...
total_word_label = Label(
    frame_output, text="Total Words:", font=("Tahona", 12, "bold"), bg="#ccffff", fg="red")
...
wrong_word_label = Label(
    frame_output, text="Wrong Words:", font=("Tahona", 12, "bold"), bg="#ccffff", fg="red")
...
accuracy_label = Label(
    frame_output, text="Accuracy:", font=("Tahona", 12, "bold"), bg="#ccffff", fg="red")
...
button_frame = Frame(mainframe, bg="#ccffff")
...
keyboard_frame = Frame(mainframe, bg="#ccffff", bd=2, relief=GROOVE)
keyboard_frame.grid(row=5, column=0, pady=3)

frame_1to0 = Frame(keyboard_frame, bg="#ccffff")
...
frame_qtop = Frame(keyboard_frame, bg="#ccffff")
...
frame_atol = Frame(keyboard_frame, bg="#ccffff")
...
frame_ztom = Frame(keyboard_frame, bg="#ccffff")
...
spaceframe = Frame(keyboard_frame, bg="#ccffff")
